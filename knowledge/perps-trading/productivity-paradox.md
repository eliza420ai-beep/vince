...
It surfaces contrarian voices I would have missed after days of manual searching. It drafts 3,000-word essays, complete with historical parallels, arithmetic checks, and outlier references. The tactical speed is astonishing. Yet my total daily hours remain stubbornly fixed.
...
In 1987, Robert Solow quipped: “You can see the computer age everywhere but in the productivity statistics.” Trillions flowed into IT. Computing power multiplied a hundredfold. Productivity growth slowed.

The resolution came only in the mid-1990s, after businesses finally redesigned processes around the new reality—supply chains, inventory systems, build-to-order models.

Paul David’s classic analogy: electric motors entered factories in the 1890s. The productivity surge arrived in the 1920s, once old steam-belt layouts were abandoned.

General-purpose technologies don’t deliver instant salvation. They demand painful complementary reinvention.We are living through the same script with generative AI.

**The 2025 Evidence**

Adoption is explosive—nearly 90% of organizations are piloting GenAI.

Reported average productivity gains hover around 19%.

Yet one in three companies see little or no improvement.

Early academic studies (MIT 2025) show many adopters experience an initial dip before eventual outperformance.

Experienced developers in controlled trials are sometimes slower with AI, spending extra cycles reviewing outputs or stretching to more ambitious tasks.

Knowledge workers save roughly 5–6% of their time—hardly the revolution promised.

The saved time doesn’t evaporate. It redirects: deeper editing, higher standards, heavier fact-checking, expanded ambition.
...
That polishing step cannot be automated away.
...
Why not keep the deepest research private?
...
I did not arrive here in isolation.

In the late 1990s, strangers on obscure forums shared code, macros, and trading frameworks for free. In crypto’s first decade, pseudonymous writers on blogs, Reddit, and early Twitter laid out Bitcoin’s monetary logic, Ethereum’s programmable vision, DeFi’s primitives—all open, no paywall.

Their generosity compound-ed into my knowledge, my positions, my current life. Hoarding the best insights now would feel like receiving an open hand and responding with a closed fist.
...
Still, those 12-hour days have a real cost.

The human layer—taste, judgment, voice—is the bottleneck and the value.

To truly buy back my time at even a modest multiple of my 1999 rate would require revenue in the mid-six figures annually.

That’s the province of the top handful of Substack writers.

Most paid newsletters earn low five figures at best.

Realistic in the near term? No.
...
No one who needs the signal gets locked out.

But the fullest expression—the complete arithmetic breakdowns, the deepest outlier sourcing, the unfiltered skepticism—will live behind the wall.

Not because I’ve turned mercenary.
...
Bitcoin at $88,000: pure monetary premium, no dilution from complexity. Ethereum at $3,000: infrastructure booming (L2s now handling the majority of activity, gas fees in pennies), yet base-layer value capture fragmented.

SuperGrok lets me pressure-test every narrative in minutes—staking dynamics, blob space constraints, institutional flow data, RWA pipelines.
...
**Riding the J-Curve Together**

I’m not resentful about the hours.
