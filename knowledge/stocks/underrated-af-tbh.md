...
Robinhood trades at 50 times earnings.
Coinbase trades at 35 times.
Even sleepy old Schwab is 25 times.

You can buy a dollar of Hyperliquid’s profits for 11 cents, while you have to pay 35–50 cents for a dollar of Robinhood’s or Coinbase’s profits — even though Hyperliquid is growing much faster and has almost no employees to pay. That gap is one of the largest valuation dislocations in public markets today.

Okay, but what does Hyperliquid actually do?

Think of it as “Robinhood for the things Robinhood is afraid to list.”

Robinhood lets you trade Apple stock and Bitcoin with a pretty phone app.
Hyperliquid lets you trade Apple stock, Bitcoin, gold, oil, Tesla pre-market moves, or even the price of Nvidia on a random Tuesday in Taiwan — 24 hours a day, with up to 50× leverage, and it all settles in under half a second.

And unlike Robinhood, which is a middleman that sends your order to Citadel, Hyperliquid is the exchange itself — built entirely on a blockchain it created from scratch. There is no corporate office in Menlo Park, no compliance department of 400 people, no Super Bowl ads. Just code and servers.

The crazy part? Traders love it. In June 2025, more money changed hands on Hyperliquid in a single month than on Robinhood all year. By November, Hyperliquid was routinely doing $15 billion of trades in a single day — roughly the same as the New York Stock Exchange on a busy day.

All of this with essentially zero marketing.
...
Then merchants realized Square was actually a software company with 90 % gross margins and network effects. The stock went up 30-fold in five years.

Hyperliquid today is where Square was in 2017 — except the margins are even higher (99 %), the growth is faster, and the addressable market (global derivatives = $2 quadrillion) is a thousand times bigger.

**The unlock controversy everyone is scared of**

Critics (and there are many) point to one big risk: starting this month (November 2025), early team members and investors are allowed to sell portions of their HYPE tokens every month for the next two years.

This is the same thing that happened to Coinbase and Robinhood when they went public — insiders sold stock and the prices dropped hard at first. The difference: Coinbase and Robinhood pay out dividends or buy back stock with 5–10 % of their profits.

Hyperliquid uses 97 % of every dollar of profit to buy back and burn HYPE tokens — automatically, every single day. In the last 12 months it has already repurchased $1 billion worth — more buybacks than Apple, Meta, and Nvidia combined in the same period.

In other words, the company is engineered to shrink its own share count even while new tokens come onto the market. If trading volume keeps growing (and it has grown every single month without fail for two years), the buybacks will eventually overwhelm the unlocks. That flywheel is already turning.

**Bottom line for non-crypto people**
...
**Why the Bears Are Probably Early**

Only 23% of the latest unlock was sold; 77% was restaked or held. Whales bought $18M pre-dip and Paradigm staked another $581M days before. Buybacks have already burned $900M+ in supply (more than Apple+Meta+Nvidia combined last year) and, at current run-rate, outpace unlocks because 97% of revenue flows straight back to the token. OI is already ticking up, TVL grew 337% in 2025, and Hyperliquid still owns 75% of DEX perps share with $2.74T yearly volume. HIP-3 slashed fees 90% for new markets and opened pre-IPO perps and aligned stables. Fear & Greed at 13 and RSI under 29 scream oversold.
