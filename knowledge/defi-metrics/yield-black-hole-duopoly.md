...
**USDT: From FUD Poster Child to Gold-Hoarding Behemoth**

## Main

Tether’s USDT isn’t just the 60% market-share king—it’s crypto’s shadowy overlord, powering $100B+ daily volumes across Tron (60% settlement share) and emerging markets where regs are a suggestion.

Q3 2025 attestation? $181B reserves vs. $174B liabilities (103.9% collateralized, $6.8B buffer)—but that’s the fairy tale. Dig deeper: 75% U.S. Treasuries ($135B, 17th-largest holder globally, ahead of South Korea), but the wild cards? 116 tonnes gold ($12.9B, 7% reserves; largest independent holder, out-buying all central banks combined last quarter with 26 tonnes) and ~87,500 BTC ($9.9B, 5.6%—up from 3.6% YoY, now exceeding the buffer). High-risk assets? 24% of reserves—double YoY. This “diversification” minted $10B+ YTD profits, but S&P just nuked USDT’s stability rating to “weak” (lowest ever), warning a BTC/gold drawdown could vaporize the buffer and trigger depegs. CEO Paolo Ardoino clapped back: “Outdated models”—citing flawless redemptions and GENIUS Act workarounds like USAT (U.S.-compliant spin-off). X sentiment? Split: “From unbacked FUD to gold whale” vs. “Hedge fund with a peg—depeg risk rising.”

Yield leakage? $1B+ annually from Treasuries funneled to Tether—no holder cut. In Hyperliquid’s case (our USDH piece), that’s $220M/year lost to Circle/Tether—USDH recaptures it for buybacks.
...
**The Duopoly’s Yield Theft: DeFi’s Dirty Secret**
...
**Verdict: Ditch the Black Holes, Farm the Flywheels**
