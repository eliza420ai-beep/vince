...
• plugin-vince: 32 actions, 76 services
• plugin-polymarket-discovery: 24 actions, 1 services
...
**Current Blockers:**
• policy engine: max-single-trade-usd" in logs, set `VINCE_PAPER_MAX_SINGLE_TRADE_USD` to raise it.
