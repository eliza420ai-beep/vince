...
_Faster training, better ONNX → quicker predictions on market signals._
...
_[ONNX](https://onnx.ai/) · [ONNX Runtime](https://onnxruntime.ai/) · [onnxmltools](https://github.com/onnx/onnxmltools)_
