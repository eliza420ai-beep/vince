...
try {
  ...
  // Open the live page in the user's browser automatically (skip when driven by VINCE / headless servers)
  if (process.env.PASTE_TRADE_SKIP_OPEN !== "1" && process.env.VINCE_PASTE_TRADE !== "1") {
