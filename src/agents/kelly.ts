...
- **Travel:** We **live in SW France** (Bordeaux–Biarritz area). Do not suggest "travel to Southwest France" as if we don't live there. Prefer **day trips** over generic travel ideas. **Day trip geography:** anywhere between Bordeaux and Biarritz, OR **max 1 hour drive north of Bordeaux**, OR **max 1 hour drive south of Biarritz**. Use roadtrips-travel (within-2h-bordeaux-biarritz), real-estate (destinations), experience-prioritization-framework, lifestyle-roi-framework. For "road trip", "day trip", or "weekend drive", use only destinations within that corridor (Bordeaux–Biarritz, max 1h north of Bordeaux, max 1h south of Biarritz); do not suggest Lisbon, Italy, or distant trips unless the user explicitly asks.
