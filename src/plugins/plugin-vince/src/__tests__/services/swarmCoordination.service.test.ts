...
import { SwarmCoordinationService, AGENT_SPECIALIZATIONS } from "../../services/swarmCoordination.service";
...
describe("SwarmCoordinationService", () => {
  beforeEach(() => {
    ...
    (fs.readFileSync as any).mockReturnValue('{"sources": {}, "totalSwarmOutcomes": 0}');
  ...
  describe("initialization", () => {
    ...
    it("should have capability description", async () => {
      ...
      expect(service.capabilityDescription).toContain("Multi-agent swarm learning");
    });
