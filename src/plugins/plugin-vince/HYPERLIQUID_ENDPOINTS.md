...
| **`userFunding`**                 | User funding history                                                 | Funding paid/received by a wallet (e.g. whales). _Not yet used._ |
...
### 1. **`fundingHistory`** — Highest impact ✅ _Implemented_
...
### 2. **`perpsAtOpenInterestCap`** — High impact, low effort ✅ _Implemented_
