 ...
 */
export const gamificationEventsTable = gamificationPgSchema.table(
  "gamification_events",
  {
  ...
  (table) => ({
    ...
    createdAtIdx: index("gamification_events_created_at_idx").on(
      table.createdAt,
    ),
    actionTypeIdx: index("gamification_events_action_type_idx").on(
      table.actionType,
    ),
    // Composite index for common query pattern: userId + actionType + createdAt
    userActionDateIdx: index("gam_events_user_action_date_idx").on(
      table.userId,
      table.actionType,
      table.createdAt,
    ),
 ...
 */
export const pointBalancesTable = gamificationPgSchema.table(
  "point_balances",
  {
  ...
  (table) => ({
    allTimePointsIdx: index("point_balances_all_time_points_idx").on(
      table.allTimePoints,
    ),
    weeklyPointsIdx: index("point_balances_weekly_points_idx").on(
      table.weeklyPoints,
    ),
 ...
 * User referral codes
 */
export const referralCodesTable = gamificationPgSchema.table(
  "referral_codes",
  {
    userId: uuid("user_id").primaryKey(),
 ...
 */
export const userChainHistoryTable = gamificationPgSchema.table(
  "user_chain_history",
  {
    userId: uuid("user_id").notNull(),
  ...
  (table) => ({
    userIdChainIdx: index("user_chain_history_user_id_chain_idx").on(
      table.userId,
      table.chain,
    ),
 ...
 */
export const gamificationCampaignsTable = gamificationPgSchema.table(
  ...
  (table) => ({
    ...
    actionTypeIdx: index("gamification_campaigns_action_type_idx").on(
      table.actionType,
    ),
  }),
);
 ...
 */
export const leaderboardSnapshotsTable = gamificationPgSchema.table(
  ...
  (table) => ({
    scopeRankIdx: index("leaderboard_snapshots_scope_rank_idx").on(
      table.scope,
      table.rank,
    ),
    scopePointsIdx: index("leaderboard_snapshots_scope_points_idx").on(
      table.scope,
      table.points,
    ),
  }),
