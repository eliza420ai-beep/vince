...
Lifestyle-only concierge for the Kelly agent: daily briefing, health, dining, hotels, wellness, surf. No trading. Kelly uses a **large the-good-life knowledge base** (200+ files: hotels, MICHELIN, wine, surf, wellness, travel, creative, home cooking, rowing, tea, entertainment, art-collecting, real-estate, brands) and **17 actions**. Lifestyle is Kelly-owned; Vince no longer has a lifestyle command (ask Kelly).

## Actions (when to use)

| Action                            | Triggers                                                                                                                                                                                                            | What it does                                                                                                                                                                                                                                   |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **KELLY_DAILY_BRIEFING**          | "what should I do today", "daily suggestions", "lifestyle briefing", "daily suggestions", "what's on today", "plan my day" (narrow)                                                                                 | Day-aware picks: restaurants open today, hotels this season, fitness/health line from the-good-life and curated-open-schedule.                                                                                                                 |
| **KELLY_LIFESTYLE**               | "lifestyle", "daily", "suggestion(s)", "health", "dining", "hotel(s)", "swim", "gym", "lunch", "wellness", "what should i do", "what to do today", "pool day", "fitness", "workout", "yoga", "curated open" (broad) | Same briefing as KELLY_DAILY_BRIEFING; broad triggers so Kelly answers all lifestyle-style prompts in one action.                                                                                                                              |
| **KELLY_RECOMMEND_PLACE**         | "recommend a hotel in X", "where to stay in X", "where to eat in X", "eat in X", "wanna go eat", "best restaurant in X", "near me", "within 2h of home"                                                             | One best pick + one alternative from the-good-life. Place-aware retrieval. Default: within 2h of home (Landes, Hossegor, Magescq, Basque coast, Saint-Émilion); for Landes/generic, only suggests places open today and prefers landes-locals. |
...
The plugin and Kelly character rely on knowledge under `knowledge/the-good-life/`. Directory map:
...
- **lifestyle/** — swimming-daily-winter-pools, surf-ocean-voice, wellness-reminders, yoga-\*, tea-dammann-freres, home-cooking, water-rowing-surf-swim-fit, creative-practice, entertainment-tastes, spa-wellness-guide, golf-guide, cycling-guide, fishing-guide, dress-code-guide, local-markets-guide, hossegor-local, buy-back-time, looksmaxxing, etc.
- **creative-production/** — oil-painting, hasselblad-fuji-capture-one, ableton-push-3, blackmagic-design, capture-one-pro, davinci-resolve, blender-claude-mcp. Used when the user asks about painting, photography, music, cinema, or Blender + Claude Desktop + MCP.
- **luxury-hotels/** — france-palaces, livethelife-places, southwest-france-5-star-complete, ski-mountain-resorts, Cape Town, Lisbon, Brussels, Amsterdam, Monaco, Ibiza, etc.
...
- **wine-tasting/** — sommelier-playbook, bordeaux-_, burgundy-_, rhone-_, loire-_, champagne, alsace, south-african-wines, whiskey, armagnac, etc.
- **surf/** — iconic-pointbreaks-world, surf-spots-by-country, surf-resorts, surf-resorts-expanded, landes-basque-home-breaks, jbay, etc.
...
- **Root** — experience-prioritization-framework.md, uhnw-destinations-2026.md, allowlist-life.md, kelly-quick-ref.md, kelly-decision-rules.md.

Add or edit markdown under `knowledge/the-good-life/` (and subdirs) so RAG and the lifestyle service can use it. The character must have `knowledge: [{ directory: "the-good-life", shared: true }]` and `ragKnowledge: true` for RAG retrieval.
...
Phases are tracked in [progress.txt](progress.txt) (Progress vs Recommendations). Implemented: Phase 1 (voice fragment + response guard), Phase 2 (last-recommendation cache + messageExamples), Phase 3 (KELLY_RECOMMEND_EXPERIENCE), Phase 4 (daily retry, optional weekly digest and winter swim reminder, observability logging), Phase 5 (plugin-todo and KELLY_DISPATCH docs below), Phase 6 (progress.txt, README roadmap, service comments). **About popup and docs kept in sync with the-good-life and 16 actions** (about-config.ts, README, progress.txt). Optional: KELLY_ART_COLLECTING (or similar) for art-collecting/\* if product asks; currently REPLY + RAG.
