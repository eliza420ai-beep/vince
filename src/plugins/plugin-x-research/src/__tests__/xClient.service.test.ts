...
describe("XClientService", () => {
  ...
  describe("error handling", () => {
    it("returns clear message on 401", async () => {
      ...
      await expect(client.searchRecent("bitcoin")).rejects.toThrow(
  ...
  describe("searchNews", () => {
    it("throws when News API unavailable 404", async () => {
      ...
      await expect(client.searchNews("bitcoin")).rejects.toThrow(
        /News API|not be available/,
      );
    });
  });
