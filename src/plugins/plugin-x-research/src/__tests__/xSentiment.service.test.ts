...
describe("XSentimentService", () => {
  ...
  describe("analyzeSentiment", () => {
    ...
    it("should weight whale accounts higher", () => {
      ...
      const bearishRetail2 = createTweet(
        "Dump it, this is bearish",
        "anotheruser",
      );
    ...
    it("should detect contrarian warning for extreme sentiment", () => {
      ...
      const tweets: XTweet[] = Array(10)
        .fill(null)
        .map(() =>
          createTweet(
            "BTC MEGA BULLISH! Moon! Parabolic! FOMO! LFG! Generational!",
          ),
        );
  ...
  describe("getTopicVibe", () => {
    ...
    it("should return null for unknown topic", () => {
      const tweets: XTweet[] = [createTweet("Some random tweet")];
