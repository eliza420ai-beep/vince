...
describe('XSearchService', () => {
  ...
  describe('searchTopic', () => {
    ...
    it('should throw for unknown topic', async () => {
      await expect(service.searchTopic('unknown_topic_xyz'))
  ...
  describe('searchMultipleTopics', () => {
    ...
    it('should handle errors gracefully', async () => {
      mockClient.searchRecent
        .mockResolvedValueOnce({ data: [createMockTweet('test', 'user')], meta: { resultCount: 1 } })
  ...
  describe('detectVolumeSpikes', () => {
    it('should detect volume spike above 2x', async () => {
      mockClient.getCounts.mockResolvedValue({
        data: [
          ...
          { start: '2024-01-01T01:00:00Z', end: '2024-01-01T02:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T02:00:00Z', end: '2024-01-01T03:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T03:00:00Z', end: '2024-01-01T04:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T04:00:00Z', end: '2024-01-01T05:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T05:00:00Z', end: '2024-01-01T06:00:00Z', tweetCount: 300 }, // 3x spike
        ],
    ...
    it('should not flag normal volume', async () => {
      mockClient.getCounts.mockResolvedValue({
        data: [
          { start: '2024-01-01T00:00:00Z', end: '2024-01-01T01:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T01:00:00Z', end: '2024-01-01T02:00:00Z', tweetCount: 110 },
          { start: '2024-01-01T02:00:00Z', end: '2024-01-01T03:00:00Z', tweetCount: 95 },
          { start: '2024-01-01T03:00:00Z', end: '2024-01-01T04:00:00Z', tweetCount: 105 },
          { start: '2024-01-01T04:00:00Z', end: '2024-01-01T05:00:00Z', tweetCount: 100 },
          { start: '2024-01-01T05:00:00Z', end: '2024-01-01T06:00:00Z', tweetCount: 105 }, // Normal
        ],
