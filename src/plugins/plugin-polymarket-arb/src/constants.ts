...
export const ENV_KEYS = {
  ...
  CONVERGENCE_TAKE_PROFIT_PCT: "POLYMARKET_ARB_CONVERGENCE_TAKE_PROFIT_PCT",
  STOP_LOSS_PCT: "POLYMARKET_ARB_STOP_LOSS_PCT",
  STALE_DATA_THRESHOLD_MS: "POLYMARKET_ARB_STALE_DATA_THRESHOLD_MS",
  CIRCUIT_BREAKER_CONSECUTIVE_LOSSES:
    "POLYMARKET_ARB_CIRCUIT_BREAKER_CONSECUTIVE_LOSSES",
  CIRCUIT_BREAKER_DAILY_DRAWDOWN_PCT:
    "POLYMARKET_ARB_CIRCUIT_BREAKER_DAILY_DRAWDOWN_PCT",
} as const;
