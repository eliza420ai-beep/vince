...
export const bankrOrderStatusAction: Action = {
  ...
  description:
    "Get status and details of a single Bankr External Order by orderId.",
  ...
  examples: [
    [
      {
        name: "user",
        content: { text: "What's the status of Bankr order xyz?" },
      },
      {
        name: "Otaku",
        content: { text: "Order xyz: …", actions: ["BANKR_ORDER_STATUS"] },
      },
    ],
  ],
};
