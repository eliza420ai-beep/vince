...
export const ENV_MODEL_VOL_FLOOR = "EDGE_MODEL_VOL_FLOOR";
export const DEFAULT_MODEL_VOL_FLOOR = 0.3;
...
export const ENV_MAKER_REBATE_PER_SHARE = "EDGE_MAKER_REBATE_PER_SHARE";
export const ENV_MAKER_FEE_CURVE_C = "EDGE_MAKER_FEE_CURVE_C";
export const ENV_MAKER_ENTRY_WINDOW_MS = "EDGE_MAKER_ENTRY_WINDOW_MS";
export const DEFAULT_MAKER_REBATE_PER_SHARE_USD = 0.001;
export const DEFAULT_MAKER_FEE_CURVE_C = 1;
export const DEFAULT_MAKER_ENTRY_WINDOW_MS = 60 * 1000;
