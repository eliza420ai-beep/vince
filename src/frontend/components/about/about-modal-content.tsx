...
const pluginItems: PluginItem[] = [
  ...
  },
  {
    ...
    category: "AI Engine",
    summary:
      "Advanced language understanding, strategy synthesis, and scenario planning.",
    points: [
  ...
  },
  {
    ...
    category: "Execution",
    summary:
      "Secure non-custodial smart wallets, balance checks, and seamless transaction signing.",
    points: [
  ...
  },
  {
    ...
    summary:
      "Access Morpho Blue lending and borrowing with real-time rate intelligence.",
    points: [
  ...
  },
  {
    ...
    category: "Launchpad",
    summary:
      "Deploy ERC-20 tokens, configure liquidity pools, and manage launches end-to-end.",
    points: [
  ...
  },
  {
    ...
    category: "News",
    summary:
      "Latest news, governance proposals, and on-chain narratives pulled from trusted sources.",
    points: [
  ...
  },
  {
    ...
    category: "Database",
    summary:
      "Query Otaku's structured DeFi dataset for trades, logs, and historical insights.",
    points: [
  ...
  },
  {
    ...
    category: "Memory",
    summary:
      "Persistent reasoning, memory recall, and adaptive response logic across sessions.",
    points: [
      "Otaku remembers preferences, risk tolerances, and previous moves.",
      "Plans multi-step workflows without losing context mid-task.",
    ],
    example:
      "Otaku adjusts recommendations based on your past trades and risk appetite.",
  },
];
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                Otaku is your autonomous DeFi trading and intelligence agent.
                She connects deep on-chain data with secure execution tools so
                you can research, plan, and act inside a single conversation.
              </p>
        ...
        <div className="flex-1 space-y-8 py-6 sm:overflow-y-auto">
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-lg border border-border/60 bg-background/80 p-4">
              <p className="text-sm text-foreground/90">
                Ask Otaku to build multi-step playbooks—she remembers previous
                trades, adapts to your risk settings, and can execute when you
                are ready.
              </p>
            </div>
          </section>
